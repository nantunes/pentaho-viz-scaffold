...
module.exports = generators.Base.extend({
  ...
  install: function() {
    this.npmInstall(['https://github.com/pentaho/pentaho-platform-plugin-common-ui'], {'save': true});
    this.npmInstall(['https://github.com/nantunes/pentaho-viz-sandbox'], {'save-dev': true});
  }
});
